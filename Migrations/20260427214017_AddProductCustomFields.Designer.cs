...
namespace StockifyPlus.Migrations
{
    ...
    [Migration("20260427214017_AddProductCustomFields")]
    partial class AddProductCustomFields
    {
            ...
            modelBuilder.Entity("StockifyPlus.Models.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2026, 4, 28, 0, 40, 16, 628, DateTimeKind.Local).AddTicks(3333));
            ...
            modelBuilder.Entity("StockifyPlus.Models.NotificationSetting", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 0, 40, 16, 628, DateTimeKind.Local).AddTicks(6954));
            ...
            modelBuilder.Entity("StockifyPlus.Models.ProductCustomField", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 0, 40, 16, 628, DateTimeKind.Local).AddTicks(9347));
            ...
            modelBuilder.Entity("StockifyPlus.Models.StockMovement", b =>
                {
                    ...
                    b.Property<DateTime>("MovementDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 0, 40, 16, 627, DateTimeKind.Local).AddTicks(5618));
