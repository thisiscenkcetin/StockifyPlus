...
namespace StockifyPlus.Migrations
{
    ...
    [Migration("20260428054320_AddWishlistModule")]
            ...
            modelBuilder.Entity("StockifyPlus.Models.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2026, 4, 28, 8, 43, 20, 137, DateTimeKind.Local).AddTicks(968));
            ...
            modelBuilder.Entity("StockifyPlus.Models.NotificationSetting", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 8, 43, 20, 137, DateTimeKind.Local).AddTicks(4318));
            ...
            modelBuilder.Entity("StockifyPlus.Models.ProductCustomField", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 8, 43, 20, 137, DateTimeKind.Local).AddTicks(6450));
            ...
            modelBuilder.Entity("StockifyPlus.Models.StockMovement", b =>
                {
                    ...
                    b.Property<DateTime>("MovementDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 8, 43, 20, 136, DateTimeKind.Local).AddTicks(4057));
            ...
            modelBuilder.Entity("StockifyPlus.Models.Wishlist", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 8, 43, 20, 138, DateTimeKind.Local).AddTicks(2675));
