...
namespace StockifyPlus.Migrations
{
    ...
    [Migration("20260428060517_AddBudgetModule")]
            ...
            modelBuilder.Entity("StockifyPlus.Models.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2026, 4, 28, 9, 5, 16, 924, DateTimeKind.Local).AddTicks(6723));
            ...
            modelBuilder.Entity("StockifyPlus.Models.Budget", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 9, 5, 16, 926, DateTimeKind.Local).AddTicks(8605));
            ...
            modelBuilder.Entity("StockifyPlus.Models.NotificationSetting", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 9, 5, 16, 925, DateTimeKind.Local).AddTicks(424));
            ...
            modelBuilder.Entity("StockifyPlus.Models.ProductCustomField", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 9, 5, 16, 925, DateTimeKind.Local).AddTicks(2638));
            ...
            modelBuilder.Entity("StockifyPlus.Models.StockMovement", b =>
                {
                    ...
                    b.Property<DateTime>("MovementDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 9, 5, 16, 923, DateTimeKind.Local).AddTicks(4433));
            ...
            modelBuilder.Entity("StockifyPlus.Models.Wishlist", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 4, 28, 9, 5, 16, 925, DateTimeKind.Local).AddTicks(9710));
