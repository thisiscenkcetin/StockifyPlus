...
namespace StockifyPlus.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Index(int page = 1, int pageSize = 20, string? search = null, int? categoryId = null)
        {
            try
            {
                var pagedResult = await _productService.GetPagedProductsAsync(page, pageSize, search, categoryId);
        ...
        public async Task<IActionResult> LowStock()
        {
            try
            {
                ...
                ViewBag.CurrentPageSize = productList.Count == 0 ? 20 : productList.Count;
                ...
                var result = new PagedResult<Models.Product>
                {
                    Items = productList,
                    CurrentPage = 1,
                    PageSize = productList.Count == 0 ? 20 : productList.Count,
